                ...
                <div class="walkers">
                    <div class="walkers-list">
                        <div class="passeador-info">
                            ...
                            <br>
                            <form action="scripts/passeio/passeio_usuario_cancelar.php" method="POST">
                                <input type="number" value="0" name="idPasseador" hidden>
                                <input type="submit" class="chamar-passeador" value="CANCELAR">
                            </form>
                        </div>
                    </div>
                </div>
